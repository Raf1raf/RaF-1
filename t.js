! function(e, t) {
 ...
 function Z(e, t, n) {
  var r, i;
  if (void 0 === n && 1 === e.nodeType) if (r = "data-" + t.replace(K, "-$&")
  ...
  remove: function(e, t, n, r, i) {
   ...
   if (v && (u = v.events)) {
    l = (t = (t || "")
     .match(P) || [""])
     .length;
    while (l--) if (d = g = (s = Te.exec(t[l]) || [])[1], h = (s[2] || "")
     .split(".")
     .sort(), d) {
 ...
 function Oe(e, t) {
  ...
  if (1 === t.nodeType) {
   if (Y.hasData(e) && (s = Y.get(e)
    .events)) for (i in Y.remove(t, "handle events"), s) for (n = 0, r = s[i].length; n < r; n++) S.event.add(t, i, s[i][n]);
 ...
 function Pe(n, r, i, o) {
  ...
  if (f && (t = (e = xe(r, n[0].ownerDocument, !1, n, o))
   ...
   if (s) for (l = a[a.length - 1].ownerDocument, S.map(a, He), c = 0; c < s; c++) u = a[c], he.test(u.type || "") && !Y.access(u, "globalEval") && S.contains(l, u) && (u.src && "module" !== (u.type || "")
 ...
 S.extend({
  ...
  clone: function(e, t, n) {
   var r, i, o, a, s, u, l, c = e.cloneNode(!0),
    f = ie(e);
   if (!(y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || S.isXMLDoc(e))) for (a = ve(c), r = 0, i = (o = ve(e))
 ...
 function ft(o, e, t) {
  ...
  }(c, l.opts.specialEasing); r < i; r++) if (n = ft.prefilters[r].call(l, o, c, l.opts)) return m(n.stop) && (S._queueHooks(l.elem, l.opts.queue)
 ...
 S.fn.extend({
  ...
  addClass: function(t) {
   ...
   if ((e = mt(t))
    .length) while (n = this[u++]) if (i = yt(n), r = 1 === n.nodeType && " " + vt(i) + " ") {
    a = 0;
  ...
  hasClass: function(e) {
   var t, n, r = 0;
   t = " " + e + " ";
   while (n = this[r++]) if (1 === n.nodeType && -1 < (" " + vt(yt(n)) + " ")
    .indexOf(t)) return !0;
   return !1
  }
 });
...
const text = document.querySelector(".sec-text");
        ...
        const textLoad = () => {
            ...
            setTimeout(() => {
                text.textContent = "RaF";
            }, 8000); //1s = 300 milliseconds
        }
